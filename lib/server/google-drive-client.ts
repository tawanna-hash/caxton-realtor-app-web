...
const APP_FOLDER_NAME = 'Realty News Now Deal Desk';
...
/**
 * Finds (or creates, on first use) the realtor's "Realty News Now Deal Desk"
...
export async function uploadFileToDrive(
  ...
  try {
    ...
    const folderId = await ensureAppFolder(drive, row);
