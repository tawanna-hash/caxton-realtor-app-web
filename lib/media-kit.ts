...
//   - Houston (50K) and Dallas/FTW (27K): $0.05 per subscriber per send
//     ($50 CPM), x 1 send per package. Package No. 1 only - no event-
...
export const EBLASTS: EBlast[] = [
  {
    ...
    sends: 2,
    priceByPub: {
      'realtyline-houston': 2500,
      'realtyline-dallas':  1350,
    },
    sendsByPub: {
