            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#021D40] focus:border-transparent"
                  disabled={sending}
                />
                <div
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#021D40] focus:border-transparent resize-none"
                  disabled={sending}
                />
                <div
                  className={`text-xs mt-1 ${
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#021D40]"
                  disabled={sending}
                >
                  {CATEGORIES.map((c) => (
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#021D40]"
                  disabled={sending}
                />
              ...
              <div>
                ...
                {schedule === 'later' && (
                  <input
                    ...
                    className="mt-2 w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#021D40]"
                    disabled={sending}
                  />
                )}
              </div>
            ...
            <div>
              ...
              <div className="bg-gray-100 rounded-xl p-4">
                <div className="bg-white rounded-lg shadow-md p-3 flex gap-3">
                  <div className="flex-shrink-0 w-10 h-10 rounded-md bg-[#021D40] text-white text-xs font-bold flex items-center justify-center">
                    RNN
                  </div>
          ...
          <footer className="border-t border-gray-200 px-6 py-4 bg-gray-50 flex items-center justify-between gap-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-md text-sm font-medium text-white bg-[#021D40] hover:bg-[#03285a] disabled:bg-gray-300 disabled:cursor-not-allowed transition-colors"
              >
