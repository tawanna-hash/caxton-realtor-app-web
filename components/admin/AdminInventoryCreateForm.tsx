...
const fieldStyle =
  'w-full border border-gray-300 px-4 py-2.5 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-[#301D5D] transition-colors disabled:bg-gray-50 disabled:text-gray-400 disabled:cursor-not-allowed rounded-md';
...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      ...
      <div className="border-t border-gray-200 pt-6 flex gap-3">
        <button
          type="submit"
          disabled={submitting}
          className="bg-[#301D5D] text-white px-4 py-2 text-sm font-medium hover:bg-[#493676] disabled:opacity-50 disabled:cursor-not-allowed rounded-md transition-colors"
        >
