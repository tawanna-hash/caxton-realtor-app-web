  ...
  return (
    <section className="relative border border-gray-300 bg-white overflow-hidden">
      ...
      <div className="absolute top-0 left-0 z-10">
        <span className="inline-block bg-[#E06100] text-white text-[10px] uppercase tracking-[0.15em] font-medium px-3 py-1.5">
          Featured
        </span>
      </div>
        ...
        <div className="flex flex-col justify-between p-6 md:p-8">
          ...
          <div className="flex flex-col gap-3">
            <button
              type="button"
              onClick={handleOpenFlyer}
              className="self-start inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white tracking-wide bg-[#E06100] hover:bg-[#FF7820] transition-colors rounded-md"
            >
              View flyer
