        ...
        <div className="flex items-center gap-2">
          ...
          {winnerName ? (
            ...
            <button
              ...
              className="bg-[#E06100] text-white px-4 py-2 text-sm font-medium hover:bg-[#FF7820] disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
            >
        ...
        <form onSubmit={handleSave} className="space-y-5">
          ...
          <div className="pt-2">
            <button
              type="submit"
              disabled={saving}
              className="bg-[#E06100] text-white px-5 py-2 text-sm font-medium hover:bg-[#FF7820] disabled:opacity-60 transition-colors"
            >
        ...
        <form onSubmit={handleAdd} className="border-t border-gray-100 pt-5 space-y-4">
          ...
          <div className="flex items-center gap-3 pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="bg-[#E06100] text-white px-4 py-2 text-sm font-medium hover:bg-[#FF7820] disabled:opacity-60 transition-colors"
            >
