        ...
        <div className="lg:col-span-3 bg-white border border-gray-200 rounded-md p-5">
          ...
          <div className="flex gap-3 mt-6">
            <button
              ...
              onClick={save}
              disabled={saving}
              className="px-5 py-2.5 bg-[#E06100] text-white rounded-md font-medium disabled:opacity-60"
            >
                ...
                >
                  <div>
                    <p className="font-semibold">
                      {r.month_label}{' '}
                      {i === 0 && <span className="ml-2 text-[10px] uppercase tracking-wider bg-[#E06100] text-white px-2 py-0.5 rounded-md">Live</span>}
                    </p>
