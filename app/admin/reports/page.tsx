      ...
      <div className="bg-white border border-gray-200 rounded-md p-6 mb-6 space-y-4">
        ...
        <div>
          <button
            ...
            className="bg-brand-700 hover:bg-[#493676] text-white px-4 py-2 rounded-md text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
          >
              ...
              <div className="flex items-start justify-between gap-4 mb-4 flex-wrap">
                ...
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  <button
                    type="button"
                    onClick={copyHtml}
                    className="bg-brand-700 hover:bg-[#493676] text-white px-3 py-1.5 rounded-md text-sm font-medium"
                  >
                    Copy HTML
                  </button>
                  <button
