      ...
      <div className="w-full max-w-md bg-white shadow-xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          <div>
            ...
            <input
              ...
              className="h-9 w-full rounded border border-gray-300 bg-white px-3 text-sm outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500"
            />
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500/30"
            />
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 px-5 py-4 flex items-center gap-3 flex-wrap">
          <button
            type="button"
            onClick={onCopyHtml}
            className="bg-orange-600 hover:bg-orange-700 text-white px-4 py-2 rounded-md text-sm font-medium whitespace-nowrap"
          >
            Copy HTML
          </button>
          <button
            type="button"
            onClick={onCopyPlain}
            className="bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 px-4 py-2 rounded-md text-sm font-medium whitespace-nowrap"
          >
            Copy plain text
          </button>
          <button
