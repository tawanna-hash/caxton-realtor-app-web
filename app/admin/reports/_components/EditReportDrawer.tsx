      ...
      <div className="w-full max-w-md bg-white shadow-xl flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-5 py-5 space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#021D40]/30"
            />
          ...
          <div>
            ...
            <select
              ...
              className="w-full border border-gray-300 rounded-md px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-[#021D40]/30"
            >
        ...
        <div className="border-t border-gray-200 px-5 py-4 flex items-center gap-3 flex-wrap">
          <button
            type="button"
            onClick={onCopyHtml}
            className="bg-[#E06100] hover:bg-[#FF7820] text-white px-4 py-2 rounded-md text-sm font-medium"
          >
            Copy HTML
          </button>
          <button
