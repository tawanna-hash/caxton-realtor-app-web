    ...
    <div className="w-full max-w-2xl">
      ...
      <div className="relative">
        <input
          ...
          className="w-full border border-gray-300 rounded-md px-3 py-2 pl-9 pr-9 text-sm focus:outline-none focus:ring-2 focus:ring-[#1a2a44]/30 focus:border-[#1a2a44]"
        />
        {/* Magnifying glass */}
        <svg
          aria-hidden="true"
            ...
            return (
              ...
              >
                ...
                {isSelected && (
                  <svg
                    viewBox="0 0 20 20"
                    className="shrink-0 w-4 h-4 text-[#1a2a44]"
                    aria-hidden="true"
                  >
                    <path
                      fill="currentColor"
