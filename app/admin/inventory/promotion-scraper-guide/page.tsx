...
// Scraper Guide (/admin/inventory/scraper-guide) and the Community Scraper
// Guide (/admin/inventory/community-scraper-guide). A visual reference for
// building a new builder/developer *promotion* scraper. Uses the real
// inventory/653 row (Drees Homes 2026 Realtor Rewards Program) as the
// gold-standard field example, with a faithful mockup of the public
// /inventory/[id] promotion page annotated with the scraper field each
// element comes from.
//
