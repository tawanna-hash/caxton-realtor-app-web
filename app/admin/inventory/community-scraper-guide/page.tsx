...
// Scraper Guide (/admin/inventory/scraper-guide). A visual reference for
// building a new builder/developer *community* scraper. Uses the real
// communities/6 row (Barksdale, M/I Homes, Leander TX) as the gold-standard
// field example, with a faithful mockup of the public /communities/[id] page
// annotated with the scraper field each element comes from.
//
