        ...
        <div className="flex gap-2">
          ...
          {tab === 'renewals'
            ...
            : <>
                ...
                />
                <button onClick={handleUploadClick} className="whitespace-nowrap px-4 py-2 rounded-md border border-gray-300 text-gray-700 text-sm hover:bg-gray-50">Upload manually signed agreement (pdf, jpeg)</button>
                <button onClick={() => setNewQuoteOpen(true)} className="whitespace-nowrap px-4 py-2 rounded-md bg-purple-700 text-white text-sm hover:bg-purple-800">Create New Proposal</button>
                <button onClick={() => setCreateAg(true)} className="whitespace-nowrap px-4 py-2 rounded-md bg-blue-600 text-white text-sm hover:bg-blue-700">Create New Agreement</button>
              </>
          }
        </div>
      </div>
