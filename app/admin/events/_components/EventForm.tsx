...
export function EventForm({
  ...
  const fieldClass =
    'w-full px-3 py-2 border border-gray-300 rounded-md text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#301D5D]/20 focus:border-[#301D5D]';
    ...
    <form onSubmit={handleSubmit} className="space-y-6 max-w-4xl">
      ...
      <div className="flex items-center justify-between gap-4 pt-2">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="px-5 py-2 bg-[#301D5D] text-white text-sm font-medium rounded-md hover:bg-[#301D5D] transition-colors disabled:opacity-50"
        >
