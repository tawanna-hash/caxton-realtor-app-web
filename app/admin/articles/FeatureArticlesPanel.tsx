...
// Featured Articles panel — nested inside the combined Monthly Articles admin
// page (app/admin/articles/ArticlesClient.tsx) as a tab. Editorial pieces
// tied to an advertiser; published ones render on that advertiser's public
// detail page beneath the event photo gallery.
    ...
    <div>
      <div className="mb-6 flex items-start justify-between gap-4 flex-wrap">
        <p className="text-sm text-gray-600 font-light max-w-2xl">
          Editorial pieces tied to a partner. Published articles appear on that
