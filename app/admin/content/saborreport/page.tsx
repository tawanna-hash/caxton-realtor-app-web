    ...
    <div className="max-w-6xl mx-auto px-6 py-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-2 max-w-2xl">
          ...
          The most recent row by release date powers the card; hero placement runs for 7 days from release, then
          the card demotes to inline placement. The public card also surfaces a link inviting SABOR members to
          sign in at sabor.mysolidearth.com for the full Market Stats download.
        </p>
      </div>
