  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="mb-6 flex flex-col md:flex-row md:items-start md:justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-600 font-light mt-2 max-w-2xl">
            Run any scraper on demand. Schedules shown in CDT; crons run daily on Vercel.
          </p>
        </div>
        <Link
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <Link href="/admin/inventory/scraper-guide" className="text-xs border border-gray-300 px-3 py-1.5 rounded-md hover:bg-gray-50 text-gray-700">
          Scraper Template
        </Link>
        <Link href="/admin/inventory/community-scraper-guide" className="text-xs border border-gray-300 px-3 py-1.5 rounded-md hover:bg-gray-50 text-gray-700">
          Community Template
        </Link>
        <Link href="/admin/inventory/promotion-scraper-guide" className="text-xs border border-gray-300 px-3 py-1.5 rounded-md hover:bg-gray-50 text-gray-700">
          Promotion Template
        </Link>
        <Link href="/admin/inventory/builders" className="text-xs border border-gray-300 px-3 py-1.5 rounded-md hover:bg-gray-50 text-gray-700">
          Advertiser Pages
        </Link>
      </div>
