  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <button
        type="submit"
        disabled={disabled}
        className="inline-flex items-center justify-center px-6 py-3 bg-brand-700 text-white font-medium rounded-md hover:bg-brand-800 disabled:bg-gray-400 disabled:cursor-not-allowed transition"
      >
