    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      {channel === 'digital' && (
        <div>
          ...
          <select
            ...
            disabled={disabled}
            className="w-full border border-gray-300 rounded px-3 py-2 text-base bg-white focus:outline-none focus:ring-2 focus:ring-[#021D40] focus:border-transparent"
          >
      ...
      <div>
        ...
        <input
          ...
          autoComplete="name"
          disabled={disabled}
          className="w-full border border-gray-300 rounded px-3 py-2 text-base focus:outline-none focus:ring-2 focus:ring-[#021D40] focus:border-transparent"
        />
      </div>
      ...
      <button
        type="submit"
        disabled={disabled}
        className="inline-flex items-center justify-center px-6 py-3 bg-[#021D40] text-white font-medium rounded hover:bg-[#03285a] disabled:bg-gray-400 disabled:cursor-not-allowed transition"
      >
