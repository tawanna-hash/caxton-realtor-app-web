    ...
    <main className="max-w-4xl mx-auto px-6 py-12 md:py-16">
      ...
      <section className="mb-10 grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="border border-gray-200 px-4 py-4">
          <p className="text-2xl font-semibold text-[#1a2a44] tracking-tight">
            43K
          </p>
            ...
            return (
              <article
                ...
                className={`relative flex flex-col border rounded p-6 ${
                  isPopular ? 'border-[#1a2a44]' : 'border-gray-200'
                }`}
              >
                {isPopular && (
                ...
                <h3 className="text-xl font-semibold text-[#1a2a44] mb-1">
                  {eb.name}
                </h3>
