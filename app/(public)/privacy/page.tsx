export const metadata = {
  title: 'Privacy Notice — HarmonyOne',
  description:
    'How Caxton Publications collects, uses, and protects information in HarmonyOne.',
};
    ...
    <main className="max-w-3xl mx-auto px-6 py-12 md:py-16">
      <div className="mb-8 bg-amber-50 border border-amber-200 px-5 py-4 rounded-sm">
        ...
        <p className="text-sm text-amber-800 font-light leading-relaxed">
          This Privacy Notice is a good-faith working draft and will be replaced
          with a counsel-reviewed version. If you have specific questions about
          how your information is handled, please email us directly at{' '}
          <a
      ...
      <section className="space-y-8 text-gray-700 text-base leading-relaxed font-light">
        <div>
          ...
          <p>
            ...
            &ldquo;us&rdquo;) operates HarmonyOne (the &ldquo;app&rdquo;) and publishes
        ...
        <div>
          ...
          <p>
            HarmonyOne is intended for adults interested in real estate news,
        ...
        <div>
          ...
          <p>
            HarmonyOne uses cookies and similar technology only for what&apos;s
