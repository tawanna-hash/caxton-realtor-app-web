export const metadata = {
  title: 'Frequently Asked Questions — HarmonyOne',
  description:
    'Common questions about signing in, notifications, account, and troubleshooting for HarmonyOne by Caxton Publications.',
};
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-gray-700 font-light leading-relaxed">
              Anyone can sign up. HarmonyOne is built for the Austin and San
