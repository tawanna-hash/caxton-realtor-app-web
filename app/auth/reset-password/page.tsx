...
function ResetPasswordInner() {
  ...
  const ic = "w-full px-4 py-3.5 border border-gray-300 text-base font-light bg-white focus:outline-none focus:border-brand-700 mb-3";
    ...
    <div className="fixed inset-0 bg-white flex flex-col items-center justify-center z-40" style={SW}>
      <div className="w-full max-w-md px-8">
        ...
        <button
          ...
          className="w-full text-center py-3.5 text-base font-medium uppercase tracking-wider text-white mb-3 bg-brand-700 disabled:opacity-40"
        >
